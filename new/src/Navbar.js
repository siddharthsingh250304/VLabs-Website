  ...
  return (
    <SciFiAppBar position="static">
      <Toolbar>
        ...
        <Button color="inherit" startIcon={<SearchIcon />} component={Link}  to="/search" >
          Search
        </Button>
        <Button color="inherit" startIcon={<CloudDownloadIcon />} component={Link} to="/downloadlist">
          Download List
        </Button>
        <Button color="inherit" startIcon={<AddIcon />} component={Link} to="/add">
          Add Question
        </Button>
