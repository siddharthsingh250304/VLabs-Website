        ...
        && (
          <Card sx={{ marginBottom: 2, padding: 2, backgroundColor: '#f5f5f5', borderRadius: '4px', textAlign: 'left', width: '80%' }}>
            <CardContent>
              ...
              <Typography variant="body1" sx={{ marginTop: 2 }} fontWeight="bold" style={{ display: 'flex', justifyContent: 'center' }}>Tags:</Typography>
              ...
              <Typography variant="body1" sx={{ marginTop: 2 }} fontWeight="bold" style={{ display: 'flex', justifyContent: 'center' }}>Difficulty:</Typography>
              <div style={{ display: 'flex', justifyContent: 'center' }}>
                <DifficultyPrint />
              </div>
